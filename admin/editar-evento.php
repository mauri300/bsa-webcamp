              ...
              <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php"> 
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="titulo_evento" name="titulo_evento" placeholder='Título Evento' value="<?php echo $evento['nombre']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select name="invitado" class="form-control seleccionar">
                        ...
                        <?php
                          try {
                            $invitado_actual = $evento['invitado_id'];
