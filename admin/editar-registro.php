  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>llena el formulario para editar usuario registrado</small>
      </h1>
    </section>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <div class="paquetes" id="paquetes">
                          <div class="box-header with-border">
                            <h3 class="box-title">Elige la cantidad de boletos</h3>
                          </div>
                          <ul class="lista-precios clearfix row">
                              <li class="tabla-precio col-md-4">
                                <div class="text-center">
                                  ...
                                  <div class="orden">
                                    ...
                                    <input value="<?php echo $boletos['un_dia']['cantidad']; ?>" type="number" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
                              ...
                              <li class="tabla-precio col-md-4">
                                <div class="text-center">
                                  ...
                                  <div class="orden">
                                    ...
                                    <input value="<?php echo $boletos['pase_completo']['cantidad']; ?>"  type="number" min="0" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0">
                              ...
                              <li class="tabla-precio col-md-4">
                                <div class="text-center">
                                  ...
                                  <div class="orden">
                                    ...
                                    <input value="<?php echo $boletos['pase_2dias']['cantidad']; ?>"  type="number" min="0" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0">
                        ...
                        <div class="caja clearfix row">
                            <div class="extras col-md-6">
                                <div class="orden">
                                    ...
                                    <input value="<?php echo $boletos['camisas']; ?>" type="number" min="0" id="camisa_evento" name="pedido_extra[camisas][cantidad]" size="3" placeholder="0">
                                    <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
                                </div><!--.orden-->

                                <div class="orden">
                                    <label for="etiquetas">Paquete de 10 etiquetas a $2 <small>(HTML5, CSS3, JavaScript)</small></label>
                                    <input value="<?php echo $boletos['etiquetas']; ?>" type="number" min="0" id="etiquetas" name="pedido_extra[etiquetas][cantidad]" size="3" placeholder="0">
                                ...
                                <input type="button" name="" id="calcular" class="btn btn-success" value="Calcular">
                            </div><!--.extras-->
